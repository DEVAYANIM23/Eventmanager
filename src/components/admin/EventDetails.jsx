...
import { db } from '../../firebase/firebaseConfig'; // Import db from your firebaseConfig
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
                Book Now
              </button>
            </div>
